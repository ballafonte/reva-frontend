...
export const getLineHeight = (fontSize: number | FontSizeType, lineHeight?: LineHeightType) => {
	const fontSizeValue = typeof fontSize === 'number' ? fontSize : FONT_SIZES[fontSize];
	const lineHeightValue = lineHeight ? LINE_HEIGHTS[lineHeight] : LINE_HEIGHTS.normal;
