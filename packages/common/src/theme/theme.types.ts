...
export type SeverityContextType = (typeof SeverityContexts)[SeverityContextKeys];
...
export type CheckedElementStateType = (typeof CheckedElementStates)[CheckedElementStateKeys];
